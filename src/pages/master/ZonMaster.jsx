...
export default function ZonMaster() {
    ...
    const columnDefs = [
        ...
        },
        {
            ...
            cellEditorParams: {
                ...
                labelMap: Object.fromEntries(
                    Object.entries(STRG_TYP_META).map(([cd, meta]) => [cd, meta.label])
                ),
            },
            cellStyle: { display: 'flex', alignItems: 'center', justifyContent: 'center' },
        ...
        },
        {
            ...
            cellEditorParams: {
                ...
                labelMap: Object.fromEntries(
                    Object.entries(BIZ_DVSN_META).map(([cd, meta]) => [cd, meta.label])
                ),
            },
            cellStyle: { display: 'flex', alignItems: 'center', justifyContent: 'center' },
    ...
    const handleAddRow = () => addRow(
        { zonCd: '', zonNm: '', tmpZon: 'DRY', strgTyp: 'RACK', bizDvsn: 'STRG' },
        'zonCd'
    );
