...
export const omsOutbOrderApi = {
    ...
    confirm(ids) {
        return api.post('/oms/outbound-orders/confirm', ids, { timeout: BATCH_TIMEOUT });
    },
    ...
    cancelConfirm(ids) {
        return api.post('/oms/outbound-orders/confirm-cancel', ids, { timeout: BATCH_TIMEOUT });
    },
    ...
    remove(ids) {
        return api.delete('/oms/outbound-orders', { params: { ids: ids.join(',') }, timeout: BATCH_TIMEOUT });
    },
};
